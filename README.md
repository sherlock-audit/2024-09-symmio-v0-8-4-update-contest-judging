...
# Issue M-4: PartyB can settle PartyA’s losing positions even when it is unnecessary and detrimental to Party A’s allocated balance 

Source: https://github.com/sherlock-audit/2024-09-symmio-v0-8-4-update-contest-judging/issues/46 
...
# Issue M-5: An excessive number of user positions can be settled even if the shortfall allocated balance needed for fulfilling the close request is only a small amount 

Source: https://github.com/sherlock-audit/2024-09-symmio-v0-8-4-update-contest-judging/issues/47 
...
# Issue M-6: Emergency close might be blocked due to insufficient allocated balance 
...
# Issue M-7: Inconsistent in the liquidation fee leads to unfairness in liquidation process 
